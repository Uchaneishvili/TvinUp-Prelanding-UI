...
import { sendEmailViaMailchimp, subscribe } from "../services/SubscribeService";
...
const Main = () => {
    ...
    return (
        <div className="main w-[100%] h-[100vh]">
            {/* <video src={videoBg} autoPlay loop muted={isVideoMuted} ref={videoRef} className="w-full h-full object-cover" /> */}
            <div className="absolute w-full h-full flex flex-col top-0 justify-center items-center">
            {showMessage && (
                    <div className={`absolute top-0 right-2 message-box text-white mt-4 flex mb-1 rounded-lg justify-center items-center p-3 ${subscriptionStatus === 200 || emailStatus === 200 ? 'bg-[#42ee5c]' : 'bg-red-500'}`} style={{ animation: "slide-in-right 0.5s forwards" }}>
                ...
                <div className="bg-[#0000004b] px-2 py-4 flex flex-col justify-center items-center rounded-xl drop-shadow-2xl gap-3">
                    <div className="flex flex-col items-center justify-center gap-1">
                        ...
                        <span className="text-4xl text-[#f74242] font-extrabold">126</span>
                    ...
                    <div className="flex lg:w-[90%] justify-center text-center items-center p-2 md:text-xl text-white font-bold">
                        <span>დაგვიტოვე ელ.ფოსტა და როგორც კი გავეშვებით პირველი შენ გაცნობებთ 🙂</span>
                    </div>
                    <form className='lg:w-[50%] mx-auto flex flex-col' onSubmit={(e) => e.preventDefault()}>
                        ...
                        <button
                            ...
                            className='text-white focus:outline-none font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center bg-[#FCD567] w-full'
                        >
                            დადასტურება
                        </button>
                    </form>
            ...
            >
                ...
                <img src={isVideoMuted ? MuteIcon : UnMuteIcon} alt={isVideoMuted ? "Unmute Video" : "Mute Video"} />
            </button>
        </div>
    );
};
